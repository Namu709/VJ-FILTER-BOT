...
API_ID = int(environ.get('API_ID', '24056975'))
API_HASH = environ.get('API_HASH', '01906c7fed23c09491c37981ebb46bee')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002110528128'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7197514593 2002107370 1893371947').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002095136619').split()]
...
auth_grp = environ.get('AUTH_GROUP', '7197514593') # give your force subscribe group id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Dramacloud:Dramacloud@cluster0.uhg1l95.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
")
